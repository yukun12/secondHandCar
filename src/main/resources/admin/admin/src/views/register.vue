  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(225, 225, 225, 1);borderRadius:26px">
        <h1 class="h1" style="color:rgba(244, 91, 75, 1);fontSize:28px;">二手车交易网站注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="地址" class="input" v-if="tableName=='yonghuxinxi'">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.shouji) && `yonghuxinxi` == this.tableName){
      ...
      if((!this.ruleForm.dizhi) && `yonghuxinxi` == this.tableName){
        this.$message.error(`地址不能为空`);
        return
      }
      if((!this.ruleForm.youxiang) && `yonghuxinxi` == this.tableName){
